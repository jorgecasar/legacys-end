---
name: gemini-api-dev
description: "Gemini API usage: models, function calling, structured outputs."
---
...
### Production Models (Gemini 2.5)
- **`gemini-2.5-pro`**: 2M tokens, best for complex reasoning, coding, research
- **`gemini-2.5-flash`**: 1M tokens, fast, balanced performance, multimodal
- **`gemini-2.5-flash-lite`**: 1M tokens, **most cost-effective**, simple tasks
- **`gemini-2.5-flash-image`**: Image generation and editing

### Preview Models (Gemini 3)
- **`gemini-3-pro-preview`**: 1M tokens, next-gen complex reasoning
- **`gemini-3-flash-preview`**: 1M tokens, next-gen fast performance
- **`gemini-3-pro-image-preview`**: 65k/32k tokens, next-gen image generation

### Cost Optimization Guide
For **simple classification/triage tasks**, use `gemini-2.5-flash-lite` (cheapest).
For **complex reasoning/coding**, use `gemini-2.5-pro` or `gemini-3-pro-preview`.
For **balanced performance**, use `gemini-2.5-flash` or `gemini-3-flash-preview`.

> [!IMPORTANT]
> Models like `gemini-2.0-*`, `gemini-1.5-*` are deprecated. Use Gemini 2.5 or 3 models above.
