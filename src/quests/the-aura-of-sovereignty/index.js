...
export const THE_AURA_OF_SOVEREIGNTY_QUEST = {
	...
	description: 'Before Alarion can connect with others, he must learn to exist without being corrupted by them.In the Toxic Swamp of Global Scope, he must find the Shield of Shadows to protect his styles and DOM from the chaotic environment.',
